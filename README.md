...
A customized fork of FoundationPress (documentation left intact below) intended for use on my blog, [adaminfinitum.com](http://www.adaminfinitum.com/)

I downloaded a copy and started customizing it in late February, 2017.

## Current Foundation version is 6.3.0. 

Updates to this theme will primarily focus on refinements like sexier buttons and cutting down on database queries.

For instance, I only write in English using UTF-8 so there's no reason for me to have database queries to return those properties, they will be hard coded.

### Need Favicons and Browser Tiles?
Another Foundation-based WordPress starter theme with lots of modern features is here: https://github.com/AmitT/podium

I was having a hard time deciding between the 2 but I liked the naming conventions and documentation better in FoundationPress.

But the note in that repo's README about generating icons through iconogen.com got me thinking...mainly thinking about how hideous, proprietary and confusing it is to try to satisfy as many devices as possible.

Iconogen was nice to use but all those HTML links it suggests adding to the `head` of your page are unneeded.

Use Iconogen.com to generate all the sizes (avoid transparency, it's rumored Apple renders it as black) then just put all those files in the root directory of you web server...no links to it needed, it's the default location where services will look for it: https://mathiasbynens.be/notes/touch-icons 
