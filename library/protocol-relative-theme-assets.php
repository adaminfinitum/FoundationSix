 ...
 * @since FoundationSix 1.1.0
 */

if ( ! class_exists( 'Foundationsix_Protocol_Relative_Theme_Assets' ) ) :
	class Foundationsix_Protocol_Relative_Theme_Assets {
		/**
	...
	$foundationsix_protocol_relative_theme_assets = new Foundationsix_Protocol_Relative_Theme_Assets;
endif;
