 ...
 *
 * @package WordPress
 * @subpackage FoundationSix
 * @since FoundationSix 2.6.0
 */
...
function foundationsix_custom_sizes( $sizes ) {
...
add_filter( 'image_size_names_choose', 'foundationsix_custom_sizes' );

// Add custom image sizes attribute to enhance responsive image functionality for content images
function foundationsix_adjust_image_sizes_attr( $sizes, $size ) {
...
add_filter( 'wp_calculate_image_sizes', 'foundationsix_adjust_image_sizes_attr', 10 , 2 );
