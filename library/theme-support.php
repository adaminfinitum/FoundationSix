...
if ( ! function_exists( 'foundationsix_theme_support' ) ) :
function foundationsix_theme_support() {
	// Add language support
	load_theme_textdomain( 'foundationsix', get_template_directory() . '/languages' );
...
add_action( 'after_setup_theme', 'foundationsix_theme_support' );
endif;
