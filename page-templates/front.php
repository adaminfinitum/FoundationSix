...
<header id="front-hero" role="banner">
	<div class="marketing">
		<div class="tagline">
			...
			<a role="button" class="download large button sites-button hide-for-small-only" href="http://abacusadvertising.com/">Abacus Advertising is Coming</a>
		</div>

		<div id="watch">
			<section id="stargazers">
				<a href="https://github.com/adaminfinitum/foundationsix">Fork Me on Github</a>
			</section>
			<section id="twitter">
				<a href="https://twitter.com/adaminfinitum">@adaminfinitum</a>
			</section>
		</div>
	</div>
...
<section class="intro" role="main">
	<div class="fp-intro">
		...
		<div <?php post_class() ?> id="post-<?php the_ID(); ?>">
			<?php do_action( 'foundationsix_page_before_entry_content' ); ?>
			...
			<?php do_action( 'foundationsix_page_before_comments' ); ?>
			<?php comments_template(); ?>
			<?php do_action( 'foundationsix_page_after_comments' ); ?>
		</div>
	</div>
</section>
<?php endwhile;?>
